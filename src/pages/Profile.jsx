      ...
      <Container>
        <Wrapper>
          <BodyContainer>
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridFirstEmail" sm={6}>
                <Label>Email</Label>
              ...
              <Form.Group as={Col} controlId="photo" sm={6}>
                ...
                <Form.Control accept=".jpg,.jpeg,.png" type="file" disabled />
              </Form.Group>
            </Row>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridFirstCell" sm={4}>
